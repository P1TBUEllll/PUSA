...
public class Server {
    ...
    public Server() throws IOException {
        ...
        // принимать запросы клиента socket = new DatagramSocket();
        // Вызов метода transmit(), чтобы передавать сообщение всем
        // клиентам, зарегистрированным в группе transmit();
    }
    ...
    public void transmit() {
        try {
            ...
            try {
                // Закрытие потока и сокета in.close();
                socket.close();
            } catch (Exception e) {
                e.printStackTrace();
            }
